...
struct mmc_host_ops {
	...
	int	(*uhs2_to_uhs1)(struct mmc_host *host);
	int	(*uhs1_to_uhs2)(struct mmc_host *host);
	void (*uhs2_set_clk)(struct mmc_host *host);
};
...
#define MMC_CAP2_AVOID_3_3V	(1 << 25)	/* Host must negotiate down from 3.3V */
	...
	struct uhs2_set_config	uhs2_set_data;	/* UHS2 set config */
