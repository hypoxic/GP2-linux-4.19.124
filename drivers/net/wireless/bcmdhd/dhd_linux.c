...
dhd_set_mac_addr_handler(void *handle, void *event_info, u8 event)
{
	...
	/* IP/ARP clear to avoid user change MAC address after set IP addr */
	dhd_aoe_hostip_clr(&dhd->pub, ifp->idx);
	dhd_aoe_arp_clr(&dhd->pub, ifp->idx);
