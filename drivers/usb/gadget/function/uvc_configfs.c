...
static struct uvcg_control_class {
	struct config_group	group;
} uvcg_control_class_fs, uvcg_control_class_ss, uvcg_control_class_ssp;
...
**uvcg_get_ctl_class_arr(struct config_item *i, struct f_uvc_opts *o)
{
	...
	if (cl == &uvcg_control_class_ssp)
		return o->uvc_ssp_control_cls;
...
static struct uvcg_streaming_class {
	struct config_group	group;
} uvcg_streaming_class_fs, uvcg_streaming_class_hs, uvcg_streaming_class_ss, uvcg_streaming_class_ssp;
...
***__uvcg_get_stream_class_arr(struct config_item *i, struct f_uvc_opts *o)
{
	...
	if (cl == &uvcg_streaming_class_ssp)
		return &o->uvc_ssp_streaming_cls;
...
int uvcg_attach_configfs(struct f_uvc_opts *opts)
{
	...
	config_group_init_type_name(&uvcg_control_class_ssp.group,
			"ssp", &uvcg_control_class_type);
	...
	configfs_add_default_group(&uvcg_control_class_ss.group,
			&uvcg_control_class_grp.group);
	configfs_add_default_group(&uvcg_control_class_ssp.group,
			&uvcg_control_class_grp.group);
	...
	config_group_init_type_name(&uvcg_streaming_class_ssp.group,
			"ssp", &uvcg_streaming_class_type);
	...
	configfs_add_default_group(&uvcg_streaming_class_ss.group,
			&uvcg_streaming_class_grp.group);
	configfs_add_default_group(&uvcg_streaming_class_ssp.group,
			&uvcg_streaming_class_grp.group);
