...
struct f_uvc_opts {
	...
	const struct uvc_descriptor_header * const	*ssp_control;
	...
	const struct uvc_descriptor_header * const	*ssp_streaming;
	...
	struct uvc_descriptor_header			*uvc_ssp_control_cls[5];
	...
	struct uvc_descriptor_header			**uvc_ssp_streaming_cls;
